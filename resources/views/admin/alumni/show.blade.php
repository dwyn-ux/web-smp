...
<div class="bg-white rounded-3xl shadow-xl border border-gray-100 p-8">
    <div class="flex flex-col md:flex-row gap-8">
        <div class="w-full md:w-1/3 bg-blue-50 rounded-3xl p-6 flex flex-col items-center gap-6 text-center">
            <img src="{{ asset($alumnus->photo) }}" alt="Foto {{ $alumnus->name }}" class="w-full h-72 object-cover rounded-3xl shadow-lg">
            <div>
        ...
        <div class="w-full md:w-2/3 space-y-6">
            ...
            <div>
                <h3 class="text-lg font-bold text-gray-800 mb-2">Sekolah Sekarang</h3>
