...
<div class="max-w-5xl mx-auto">
    <style>
        ...
        .article-editor:empty::before { content: attr(data-placeholder); color: #9ca3af; pointer-events: none; }
        ...
        @media (max-width: 640px) { .article-editor { min-height: 320px; } }
    </style>
                ...
                <div class="md:col-span-2 space-y-6">
                    ...
                    <div>
                        ...
                        <div class="overflow-hidden rounded-xl border border-gray-300 bg-white focus-within:border-blue-600 focus-within:ring-2 focus-within:ring-blue-100">
                            ...
                            <div id="visual-editor" class="article-editor p-5 outline-none" contenteditable="true" data-placeholder="Tulis konten artikel di sini...">{!! old('content', '') !!}</div>
                        </div>
...
<script>
    @include('admin.articles.partials.visual-editor-script')
    ...
    document.getElementById('generate-article').addEventListener('click', function () {
        ...
        .catch(() => {
            this.disabled = false;
            this.textContent = 'Generate Konten AI';
            alert('Terjadi kesalahan saat membuat konten AI.');
        });
    });
</script>
@endsection
